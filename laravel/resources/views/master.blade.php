...
<head>
    ...
    <link rel="stylesheet" href="css/@yield('style')/style.css">
                                    ...
                                    <li><!--User panel like modal?-->
                                        <div class="d-flex user-panel">
                                            ...
                                            <div class="user-panel-nav d-flex flex-column border border-primary p-3 ms-1">
                                                <a class="p-2" href="Profile.html">Profile</a>
                                                <a class="p-2" href="Settings.html">Settings</a>
                                                <a class="p-2" href="/Ranking">Ranking</a>
                                                <a class="p-2" href="/Quests">Quests</a>
                                                <a class="p-2" href="/Auction">Auction</a>
                                                <a class="p-2" href="?=action=logout">Logout</a>
                                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" class="d-flex flex-column">
                        <input class="my-1 p-2 border border-primary form-control" type="text" placeholder="Login" required>
                        <input class="my-1 p-2 border border-primary form-control" type="password" placeholder="Password" required>

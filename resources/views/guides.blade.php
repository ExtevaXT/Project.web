...
@section('content')
    <div class="d-flex flex-column">
        ...
        <a href="/guides/Armor" class="input-glass p-2 my-1 text-link d-flex">
        ...
        <a href="/guides/Container" class="input-glass p-2 my-1 text-link d-flex">
        ...
        <a href="/guides/Attachment" class="input-glass p-2 my-1 text-link d-flex">
        ...
        <a href="/guides/Weapon" class="input-glass p-2 my-1 text-link d-flex">
        ...
        <a href="/guides/Medicine" class="input-glass p-2 my-1 text-link d-flex">
